...
# Type: New Service
#
# Title: AD - Move User in OU
#
# v 1.0 Initial Release
# v 1.1 Added Stored Credentials
#       see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_MoveUser&utm_content=PS1
...
# Code Template V 1.3
#
# URL: https://au2mator.com/move-user-in-ou-active-directory-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=AD_MoveUser&utm_content=PS1
# Github: https://github.com/au2mator/AD-Move-User-in-OU
#################
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AD - Move User in OU"
[string]$LogfileName = "Move User in OU"

[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_MoveUser&utm_content=PS1
...
# Stored Credentials
# See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_MoveUser&utm_content=PS1
...
Write-au2matorLog -Type INFO -Text "Try to move User in OU"

try {
    Move-ADObject -Identity $c_User -TargetPath $c_OU
    Write-au2matorLog -Type INFO -Text "User moved"

    $au2matorReturn = "User $((Get-ADUser -identity $c_User).Name) moved"
    $AdditionalHTML = "<br>
        User $((Get-ADUser -identity $c_User).Name) has been moved
        <br>
        "
    $Status = "COMPLETED"
}
    ...
    Write-au2matorLog -Type ERROR -Text "failed to move User"
    Write-au2matorLog -Type ERROR -Text $Error

    $au2matorReturn = "failed to move User $((Get-ADUser -identity $c_User).Name), Error: $Error"
    $AdditionalHTML = "<br>
    failed to move User $((Get-ADUser -identity $c_User).Name)
    <br>
    Error: $Error
    "
